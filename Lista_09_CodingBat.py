...
def maior_ponta(nums):
  ...
  for i in range (len(nums)):
    final.append(nums[0]) if nums[0] > nums[-1] else final.append(nums[-1])
  return final
...
def squirrel_play(temp, is_summer):
  return temp in range (60, 91) and not is_summer or is_summer and temp in range (60, 101)
